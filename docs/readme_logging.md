...
The current rotation is stored in the log within the training loop. For jobs with only one subject or subject-pair, this will be 0-1. Else 0-n. The rotation is stored as a dict. <i>{test_subject: rotation+1}</i>
